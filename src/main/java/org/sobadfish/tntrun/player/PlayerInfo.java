package org.sobadfish.tntrun.player;
...
import org.sobadfish.tntrun.event.PlayerGameDeathEvent;
import org.sobadfish.tntrun.manager.TotalManager;
import org.sobadfish.tntrun.player.message.ScoreBoardMessage;
...
//        playerType = PlayerType.DEATH;
        ...
        if(playerType == PlayerType.WATCH){
            getGameRoom().joinWatch(this,true);
        }
    }
